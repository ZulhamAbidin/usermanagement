...
<div class="bungkus">
    ...
    <div class="main">
        ...
        <div class="px-6">
            ...
            <h1 class="text-xl font-bold text-gray-900 block mb-4 pb-4 -mt-10 lg:mt-7 border-b-2">Tambah Data</h1>
            ...
            <form action="{{ url('/dashboard/data') }}" method="POST">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="nama_lengkap" class="text-sm font-medium text-gray-900 block mb-2">Nama
                            Lengkap</label>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="pendidikan_terakhir" class="text-sm font-medium text-gray-900 block mb-2">Alamat
                            Domisili</label>
                        <select name="alamat_domisili"
                            ...
                            <option value="Kabupaten Pangkajene dan Kepulauan">Kabupaten Pangkajene dan Kepulauan
                            </option>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="pendidikan_terakhir" class="text-sm font-medium text-gray-900 block mb-2">Pendidikan
                            Terakhir</label>
                        <select name="pendidikan_terakhir"
                            class="block appearance-none w-full bg-gray-200 border  focus:ring-temaku focus:border-temaku border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="tanggal_pengesahan" class="text-sm font-medium text-gray-900 block mb-2">Jurusan</label>
