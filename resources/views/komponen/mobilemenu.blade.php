<div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
            ...
            <a href="" class="flex mr-auto">
                <img alt="" class="w-6" src="dist/images/naker.png">
            </a>
            ...
            <ul class="scrollable__content py-2">
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu__title"> Data Pekerja <i data-lucide="chevron-down"
                    ...
                    <ul class="menu__sub-open">
                        ...
                        <li>
                            <a href="" class="menu">
                                ...
                                <div class="menu__title"> Lihat Data  </div>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="" class="menu">
                                ...
                                <div class="menu__title"> Tambah Data  </div>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="" class="menu">
                                ...
                                <div class="menu__title"> Cetak Data </div>
                            </a>
                        </li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        <div class="menu__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="folder" data-lucide="folder"
                                class="lucide lucide-folder block mx-auto">
                                <path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"></path>
                            </svg>
                        </div>
                        <div class="menu__title"> Dokumen <i data-lucide="chevron-down" class="menu__sub-icon "></i>
                        </div>
                    </a>
                    ...
                    <ul class="">
                        <li>
                            <a href="" class="menu">
                                ...
                                <div class="menu__title"> Unggah Dokumen </div>
                            </a>
                        </li>
                        <li>
                            <a href="" class="menu">
                                ...
                                <div class="menu__title"> Lihat Dokumen </div>
                            </a>
                        </li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        <div class="menu__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="users" data-lucide="users"
                        ...
                        <div class="menu__title"> Management User <i data-lucide="chevron-down" class="menu__sub-icon "></i></div>
                    </a>
                    ...
                    <ul class="">
                        <li>
                            <a href="side-menu-light-categories.html" class="menu">
                                ...
                                <div class="menu__title"> Tambah User </div>
                            </a>
                        </li>
                        <li>
                            <a href="side-menu-light-add-product.html" class="menu">
                                ...
                                <div class="menu__title"> Lihat User </div>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="side-menu-light-inbox.html" class="menu">
                        <div class="menu__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="settings" data-lucide="settings"
                    ...
                    <a href="side-menu-light-inbox.html" class="menu">
                        <div class="menu__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                class="lucide lucide-log-out block mx-auto">
