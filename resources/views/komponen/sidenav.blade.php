<nav class="side-nav">
    <a href="" class="intro-x flex items-center pl-5 pt-4">
        <!-- <img alt="Midone - HTML Admin Template" class="w-10" src="dist/images/naker.png"> -->
        <svg xmlns="http://www.w3.org/2000/svg" class="w-10 text-white" width="24" height="24" viewBox="0 0 24 24"
            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            icon-name="folder" data-lucide="folder" class="lucide lucide-folder block mx-auto">
            <path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"></path>
        </svg>
        <span class="hidden xl:block text-white text-lg ml-3"> E-Document </span>
    </a>
            ...
            <ul class="side-menu__sub-open">
                <li>
                    <a href="/data" class="side-menu side-menu--active">
                        ...
                        <div class="side-menu__title"> Lihat Data </div>
            ...
            <ul class="">
                <li>
                    <a href="index.html" class="side-menu">
                        ...
                        <div class="side-menu__title"> Unggah Dokumen </div>
                    </a>
                </li>
                <li>
                    <a href="simple-menu-light-dashboard-overview-1.html" class="side-menu">
                        ...
                        <div class="side-menu__title"> Lihat Document </div>
                    </a>
                </li>
            </ul>
        </li>
            ...
            <ul class="">
                <li>
                    <a href="side-menu-light-categories.html" class="side-menu">
                        ...
                        <div class="side-menu__title"> Tambah User </div>
                    </a>
                </li>
                <li>
                    <a href="side-menu-light-add-product.html" class="side-menu">
                        ...
                        <div class="side-menu__title"> Lihat User </div>
                    </a>
                </li>
            </ul>
        </li>
